      ...
      const participatePrivatePresale = () => {
		...
		let _privatePresaleContract = new _web3.eth.Contract(PRIVATE_SALE_ABI,PRIVATE_SALE);
	 	...
	 	let _deposit =  depositAmount ;
	 	 _deposit =  depositAmount * 1e1 ** raiseTokenDetails[2];
          _deposit  =_deposit.toString();
          _deposit = _web3.utils.toBN(_deposit);
                                                ...
                                                }
 {
                                        ...
                                        <div className="mt-4">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td className="abcd">Token Reuirement ?</td>
                                                 ...
                                                 <a  onClick={checkWhiteList} >Check Whitelist</a>
                                             {
                                                 ...
                                                 <>
                                                  ...
                                                  <a   onClick={toggleWhitelist} >Toggle Whitelist</a>
                                                        ...
                                                        <a   onClick={changeSaleTokenLimit} >Change IDOScan Requirement (Use 0 to remove)</a>
                                                 ...
                                                 }                                     
                                                 {
                                                    ...
                                                    {
                                                   wallet.account == "0xecd73e2581aD5B86a31F5FF77CDaddcAbcB61B18"  && 
                                                      <>
                                             ...
                                             }
                                              {
                                                   wallet.account == "0xecd73e2581aD5B86a31F5FF77CDaddcAbcB61B18"  && presale.status == 2 && 
                                                    ...
                                                    {
                                                   wallet.account == "0xecd73e2581aD5B86a31F5FF77CDaddcAbcB61B18"  && presale.status == 4 && 
                                                      <>
