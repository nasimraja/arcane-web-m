...
import MultiStakeCard from "./MultiStakeCard";

const STAKE_CONTRACT = 
[ 
    {address: '0x10b79ef3A3Ee5e0f43aF07a90f464CafE7500243', nft: '0xB7d25F0E588d11929f20979B577ecd534D8Db891',image : CDP, status: 1, fee: 1 ,feedecimal: 100 , ape: 0, lp: 0 },
];
				...
				<section id="choose-sec">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                               ...
                               <div className="inactive-box mb-3">
                            	...
                            	{STAKE_CONTRACT.length > 0 && STAKE_CONTRACT.map((value, index) => {
                                    if(value.status == 1){
                                   return   <MultiStakeCard data={STAKE_CONTRACT[index]} />
                                }
                            ...
                            {STAKE_CONTRACT.length > 0 && STAKE_CONTRACT.map((value, index) => {
                                    if(value.status == 0){
                                   return   <StakeCard data={STAKE_CONTRACT[index]} />
                                }
