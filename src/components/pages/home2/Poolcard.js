...
const getApr = async () => {
    ...
    let RROUTER_ADDRESS = null ; 
        ...
        if(v.rape == 0){
            ...
            _rdomain = "https://dex.knightswap.financial/#/swap?outputCurrency=" ;
            _rdomainLp = "https://dex.knightswap.financial/#/add/" ;
        }
        ...
        if(v.sape == 0){
            ...
            _sdomain = "https://dex.knightswap.financial/#/swap?outputCurrency=" ;
            _sdomainLp = "https://dex.knightswap.financial/#/add/" ;
        }
    ...
    <div class="faq-singular" itemscope itemprop="mainEntity" >
				...
				<ul className="arp-list2">
                            ...
                            <div className="wrp-arp2 text-center font-big">
                                ...
                                <p>
                                Stake {poolsArray.stakeToken} <a href={slink} target="_blank"  ><i className="fa fa-external-link mrticon"></i></a>  EARN {poolsArray.rewardToken } <a href={rlink} target="_blank" ><i className="fa fa-external-link"></i></a>
                                </p>
