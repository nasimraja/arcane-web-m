    ...
    _marketPlaceContract.methods.withdraw(props.tradeid).send({
      ...
      async function approveToken(){
		...
		return(
             ...
             <div className="likes-wrp d-flex w-100 justify-content-between">
                 ...
                 <h4 className="busd">100 BUSD</h4>

                 </div>
              <div class="product-content">
             
                  <h5 className="product-name"><a href={"/product/"+props.tradeid}>{name}</a></h5>
                  
                  <div className="more-detail">
                    {
                  bidStatus != 4 && 
                    <ul className="m-0">
                      <li className="d-flex justify-content-between"><p className="title">Highest Bid</p> <p className="value  ">{highestBid} {symbol}</p> </li>
                      <li className="d-flex justify-content-between"><p className="title">Your Bid</p> <p className="value  ">{userbid} {symbol}</p> </li>
                      {
                       
                        endTime != 0   ?
                      <li className="d-flex justify-content-between"><p className="title">Ends In</p> <p className="value  ">{endTime}</p> </li>
                      :
                        highestBidder == lister ?
                      <li className="d-flex justify-content-between"><p className="title">Expired</p> </li>
                      :
                      <li className="d-flex justify-content-between"><p className="title">Sold Out</p> </li>
