...
import Config, { API_URL, MARKETPLACE } from '../../../Config/index.js';
...
const ExploreNew = () => {
  ...
  const getAllStatus = async () => {
    ...
    let _getURI = API_URL + "/marketplace";
    let _imported = await fetch(_getURI);
    _imported = await _imported.json();
            ...
            <section id="product-tips">
              ...
              <div className="main-marketplace">
                <div className="main-tab-box">
                  <ul className="tabs6" >
                    <li class="tab-button"><a href="#" class="tab-link " data-tab="onsale">Auction</a></li>
                    <li class="tab-button"><a href="#" class="tab-link active" data-tab="onbuy">Fixed Price</a></li>
                  ...
                  <ul className="your-list" >
                    ...
                    <li className='genbutn'><a href={"/collection/" + wallet.account}  >Your Listings</a></li>
                ...
                <div class="tab-pane">
                  <div className="tab-panel" id="onsale">
                    <div className="row">
                  ...
                  <div class="tab-panel row active" id="onbuy">
                    <div className="row">
                      {
