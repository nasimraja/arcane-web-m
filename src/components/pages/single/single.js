...
import Config, { API_URL, MARKETPLACE } from "../../../Config"
...
const Single = () => {
    ...
    const [instantsale, setInstantsale] = useState(true);
    ...
    const putauction = async (id) => {
        ...
        _sPrice = _sPrice.toString();
        _sPrice = _web3.utils.toBN(_sPrice);
        ...
        setOnSaleModal(true);
        if (instantsale) {
            console.log(id, _sPrice, auctionToken, _title)
                                        ...
                                        <div class="wrp-royalities marti-top">
                                            <div class="royalities-child mart-in">
                                                ...
                                                <input placeholder="eg. size"
                                                    ...
                                                    value={tags} className="tag-input" />
                                            </div>
